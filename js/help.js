...
function HELP_CLASS() {
	...
	this.help_about = function () {
		var email = 'mandar258@gmail.com';
		POP.add({title: "Name:", value: "webPaint"});
		POP.add({title: "Description:", value: 'online paint'});
		POP.add({title: "Author:", value: 'Mandar Tawde'});
		POP.add({title: "Email:", html: '<a href="mailto:' + email + '">' + email + '</a>'});
		POP.add({title: "Source:", html: '<a href="https://github.com/mandar-tawde/webPaint">github.com/mandar-tawde/webPaint</a>'});
		POP.show('About', '');
	};
}